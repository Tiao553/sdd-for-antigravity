...
|----------|-------|----------|
| `BRAINSTORM_{FEATURE}.md` | 0 | `.agents/sdd/features/` |
| `DEFINE_{FEATURE}.md` | 1 | `.agents/sdd/features/` |
| `DESIGN_{FEATURE}.md` | 2 | `.agents/sdd/features/` |
| `BUILD_REPORT_{FEATURE}.md` | 3 | `.agents/sdd/reports/` |
| `SHIPPED_{DATE}.md` | 4 | `.agents/sdd/archive/{FEATURE}/` |
