...
```text
Phase 0: /brainstorm → .agents/sdd/features/BRAINSTORM_{FEATURE}.md (THIS COMMAND)
...
```markdown
Read(GEMINI.md)
Read(.agents/sdd/templates/BRAINSTORM_TEMPLATE.md)
...
```markdown
Write(.agents/sdd/features/BRAINSTORM_{FEATURE}.md)
```
...
| Artifact | Location |
|----------|----------|
| **Brainstorm Document** | `.agents/sdd/features/BRAINSTORM_{FEATURE}.md` |

**Next Step:** `/define .agents/sdd/features/BRAINSTORM_{FEATURE}.md`
