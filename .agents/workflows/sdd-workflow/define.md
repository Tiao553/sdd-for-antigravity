...
/define .agents/sdd/features/BRAINSTORM_NOTIFICATION_SYSTEM.md
...
Phase 1: /define     → .agents/sdd/features/DEFINE_{FEATURE}.md (THIS COMMAND)
...
```markdown
Read(.agents/sdd/templates/DEFINE_TEMPLATE.md)
Read(GEMINI.md)
...
```markdown
Write(.agents/sdd/features/DEFINE_{FEATURE_NAME}.md)
```
...
| Artifact | Location |
|----------|----------|
| **DEFINE** | `.agents/sdd/features/DEFINE_{FEATURE_NAME}.md` |

**Next Step:** `/design .agents/sdd/features/DEFINE_{FEATURE_NAME}.md`
