...
```bash
/design .agents/sdd/features/DEFINE_NOTIFICATION_SYSTEM.md
/design DEFINE_USER_AUTH.md
/design .agents/sdd/features/DEFINE_SEARCH_API.md
```
...
Phase 2: /design     → .agents/sdd/features/DESIGN_{FEATURE}.md (THIS COMMAND)
...
Read(.agents/sdd/templates/DESIGN_TEMPLATE.md)
Read(GEMINI.md)
...
```markdown
Write(.agents/sdd/features/DESIGN_{FEATURE_NAME}.md)
```
...
| Artifact | Location |
|----------|----------|
| **DESIGN** | `.agents/sdd/features/DESIGN_{FEATURE_NAME}.md` |

**Next Step:** `/build .agents/sdd/features/DESIGN_{FEATURE_NAME}.md`
