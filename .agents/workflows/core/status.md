...
```text
# Active features
Glob(".agents/sdd/features/BRAINSTORM_*.md")
Glob(".agents/sdd/features/DEFINE_*.md")
Glob(".agents/sdd/features/DESIGN_*.md")

# Build reports
Glob(".agents/sdd/reports/BUILD_REPORT_*.md")

# Recently shipped
Glob(".agents/sdd/archive/*")
```
...
| Documentation | {GEMINI.md exists/missing}, {README.md exists/missing} | |
...
Detecting project health...
  47 test files, GEMINI.md present, 12 TODOs
...
| Documentation | Present | GEMINI.md and README.md both exist |
...
| `/sync-context` | Keep GEMINI.md in sync after recent changes |
```
