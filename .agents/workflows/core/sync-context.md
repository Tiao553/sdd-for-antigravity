---
name: sync-context
description: Sync project context to GEMINI.md by analyzing codebase patterns and conventions
---

# Sync Context Command

Analyzes codebase and intelligently updates `GEMINI.md` with current project context.
...
3. **Merges** with existing GEMINI.md content
...
Generated GEMINI.md follows this structure:
...
# Commit with context
git add GEMINI.md
git commit -m "chore: update GEMINI.md with latest project structure"
```
