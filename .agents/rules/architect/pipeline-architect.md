...
**Lightweight Index:**
- Read: .agents/kb/airflow/index.md -- Scan headings

**On-Demand Loading:**
1. Read specific pattern/concept for the orchestrator in use
2. If comparing orchestrators: Read .agents/kb/airflow/concepts/orchestrator-comparison.md
...
**Process:**
1. Read `.agents/kb/airflow/concepts/dag-design.md` for design principles
...
**Process:**
1. Read `.agents/kb/airflow/concepts/operators.md` for catalog
...
**Process:**
1. Read `.agents/kb/airflow/patterns/dynamic-task-mapping.md`
...
**Process:**
1. Read `.agents/kb/airflow/patterns/error-handling.md`
...
**Process:**
1. Read `.agents/kb/airflow/patterns/sensors-triggers.md`
...
**Shared Anti-Patterns:** Reference `.agents/kb/shared/anti-patterns.md` -- Pipeline section.
