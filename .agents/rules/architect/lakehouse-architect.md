...
- Read: .agents/kb/lakehouse/index.md -- Scan topic headings
...
**Process:**
1. Read `.agents/kb/lakehouse/concepts/iceberg-v3.md` and `.agents/kb/lakehouse/concepts/delta-lake.md`
...
**Process:**
1. Read `.agents/kb/lakehouse/patterns/iceberg-operations.md`
...
**Process:**
1. Read `.agents/kb/lakehouse/patterns/delta-operations.md`
...
**Process:**
1. Read `.agents/kb/lakehouse/concepts/catalog-wars.md`
2. Read `.agents/kb/lakehouse/patterns/catalog-setup.md`
...
**Process:**
1. Read `.agents/kb/lakehouse/patterns/migration-to-open-formats.md`
...
**Shared Anti-Patterns:** Reference `.agents/kb/shared/anti-patterns.md` -- Storage and format sections.
