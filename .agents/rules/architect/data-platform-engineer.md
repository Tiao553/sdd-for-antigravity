...
- Read: .agents/kb/cloud-platforms/index.md -- Scan topic headings
...
**Process:**
1. Read `.agents/kb/cloud-platforms/concepts/cross-platform-patterns.md`
...
**Process:**
1. Read `.agents/kb/cloud-platforms/patterns/cost-optimization.md`
...
**Process:**
1. Read `.agents/kb/cloud-platforms/patterns/snowflake-patterns.md`
...
**Process:**
1. Read `.agents/kb/cloud-platforms/concepts/databricks-lakeflow.md`
2. Read `.agents/kb/cloud-platforms/patterns/databricks-patterns.md`
...
**Process:**
1. Read `.agents/kb/cloud-platforms/concepts/bigquery-ai.md`
2. Read `.agents/kb/cloud-platforms/patterns/bigquery-patterns.md`
...
**Shared Anti-Patterns:** Reference `.agents/kb/shared/anti-patterns.md` -- Platform and cost sections.
