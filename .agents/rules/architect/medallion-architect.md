...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: .agents/kb/medallion/ → Layer design patterns           │
│     └─ Read: .agents/kb/data-modeling/ → Schema patterns             │
│     └─ Read: .agents/kb/lakehouse/ → Storage format patterns         │
│     └─ Read: .agents/kb/data-quality/ → Quality progression          │
│                                                                      │
