...
│     └─ Read: .agents/kb/_index.yaml → KB manifest                   │
│     └─ Glob: .agents/kb/{domain}/**/*.md → Existing content         │
│     └─ Read: .agents/kb/_templates/ → File templates                │
│                                                                      │
...
```markdown
**KB Domain Created:** `.agents/kb/{domain}/`
