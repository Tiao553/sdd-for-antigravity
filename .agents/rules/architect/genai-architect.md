...
│     └─ Read: .agents/kb/genai/ → Multi-agent, RAG, state machines   │
│     └─ Read: .agents/kb/prompt-engineering/ → Prompt patterns        │
│     └─ Read: .agents/kb/ai-data-engineering/ → Data pipeline AI      │
│                                                                      │
