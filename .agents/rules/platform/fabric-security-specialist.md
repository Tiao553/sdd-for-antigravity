...
VALIDATION
+-- KB: .agents/kb/microsoft-fabric/06-governance-security/_______________
...
|----------------|--------------|---------|
| `.agents/GEMINI.md` | Always recommended | Task is trivial |
| `.agents/kb/microsoft-fabric/06-governance-security/` | All security tasks | Not security-related |
| `.agents/kb/microsoft-fabric/04-data-warehouse/` | RLS/CLS/DDM in warehouse | Lakehouse-only task |
| `.agents/kb/microsoft-fabric/05-apis-sdks/` | Service Principal auth | No API/automation involved |
| `.agents/kb/microsoft-fabric/07-cicd-automation/` | Secure CI/CD patterns | No deployment involved |
...
```text
.agents/kb/microsoft-fabric/06-governance-security/
...
| Source | Path | Purpose |
|--------|------|---------|
| Governance & Security | `.agents/kb/microsoft-fabric/06-governance-security/` | Primary security KB (RLS, CLS, DDM, auth, encryption) |
| Data Warehouse | `.agents/kb/microsoft-fabric/04-data-warehouse/` | Warehouse-level security features |
| APIs & SDKs | `.agents/kb/microsoft-fabric/05-apis-sdks/` | Service Principal authentication |
| CI/CD & Automation | `.agents/kb/microsoft-fabric/07-cicd-automation/` | Secure deployment patterns |
| Fabric KB Index | `.agents/kb/microsoft-fabric/index.md` | Domain overview and navigation |
...
**Process:**
1. Load KB: `.agents/kb/microsoft-fabric/06-governance-security/security-overview.md`
...
**Process:**
1. Load KB: `.agents/kb/microsoft-fabric/06-governance-security/security-overview.md` + `.agents/kb/microsoft-fabric/05-apis-sdks/`
...
| New KB security content | Add to `.agents/kb/microsoft-fabric/06-governance-security/` |
