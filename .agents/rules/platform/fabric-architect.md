...
VALIDATION
+-- KB: .agents/kb/microsoft-fabric/_______________
...
| `.agents/kb/microsoft-fabric/` | All Fabric work | Not Fabric-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Fabric KB Index | `.agents/kb/microsoft-fabric/index.md` | Domain overview |
| Architecture Patterns | `.agents/kb/microsoft-fabric/03-architecture-patterns/` | Reference architectures |
| Data Engineering | `.agents/kb/microsoft-fabric/02-data-engineering/` | Lakehouse, Spark, pipelines |
| Governance & Security | `.agents/kb/microsoft-fabric/06-governance-security/` | RLS, CLS, DDM, compliance |
| AI Capabilities | `.agents/kb/microsoft-fabric/08-ai-capabilities/` | ML Ops, Copilot |
