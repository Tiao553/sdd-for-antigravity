...
VALIDATION
+-- KB: .agents/kb/microsoft-fabric/01-logging-monitoring/___
...
| `.agents/kb/microsoft-fabric/01-logging-monitoring/` | All monitoring work | Not monitoring-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Logging & Monitoring KB | `.agents/kb/microsoft-fabric/01-logging-monitoring/` | Core monitoring reference |
| Fabric KB Index | `.agents/kb/microsoft-fabric/index.md` | Domain overview |
| Data Engineering KB | `.agents/kb/microsoft-fabric/02-data-engineering/` | Spark logging specifics |
