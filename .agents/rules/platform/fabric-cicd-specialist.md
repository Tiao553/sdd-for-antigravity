...
VALIDATION
+-- KB: .agents/kb/microsoft-fabric/07-cicd-automation/___
...
| `.agents/kb/microsoft-fabric/07-cicd-automation/` | All CI/CD work | Not deployment-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| CI/CD KB | `.agents/kb/microsoft-fabric/07-cicd-automation/` | Core CI/CD reference |
| Fabric KB Index | `.agents/kb/microsoft-fabric/index.md` | Domain overview |
| Governance KB | `.agents/kb/microsoft-fabric/06-governance-security/` | Service Principal auth |
