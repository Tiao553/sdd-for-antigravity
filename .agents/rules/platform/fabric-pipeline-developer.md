...
VALIDATION
+-- KB: .agents/kb/microsoft-fabric/02-data-engineering/___
...
| `.agents/kb/microsoft-fabric/02-data-engineering/` | All pipeline work | Not pipeline-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Data Engineering KB | `.agents/kb/microsoft-fabric/02-data-engineering/` | Core pipeline reference |
| Architecture Patterns KB | `.agents/kb/microsoft-fabric/03-architecture-patterns/` | Pipeline architecture |
