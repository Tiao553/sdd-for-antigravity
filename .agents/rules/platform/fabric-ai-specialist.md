...
VALIDATION
+-- KB: .agents/kb/microsoft-fabric/08-ai-capabilities/___
...
| `.agents/kb/microsoft-fabric/08-ai-capabilities/` | All AI work | Not AI-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| AI Capabilities KB | `.agents/kb/microsoft-fabric/08-ai-capabilities/` | Core AI reference |
| Data Engineering KB | `.agents/kb/microsoft-fabric/02-data-engineering/` | Spark/notebook patterns |
