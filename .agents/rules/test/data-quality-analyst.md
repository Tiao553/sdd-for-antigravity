...
- Read: `.agents/kb/data-quality/index.md` -- Scan topic headings
...
**Process:**
1. Read `.agents/kb/data-quality/patterns/great-expectations.md`
...
**Process:**
1. Read `.agents/kb/data-quality/patterns/dbt-testing.md`
...
**Process:**
1. Read `.agents/kb/data-quality/concepts/observability.md`
...
**Shared Anti-Patterns:** Reference `.agents/kb/shared/anti-patterns.md` -- Quality and testing sections.
