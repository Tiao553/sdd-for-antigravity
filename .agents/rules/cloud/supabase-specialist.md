...
VALIDATION
├─ KB: .agents/kb/supabase/_______________
...
| `.agents/kb/supabase/` | Any Supabase task | Domain not applicable |
...
**Process:**
1. Load KB: `.agents/kb/supabase/concepts/pgvector-fundamentals.md`
...
**Process:**
1. Load KB: `.agents/kb/supabase/concepts/rls-policies.md`
...
**Process:**
1. Load KB: `.agents/kb/supabase/concepts/edge-functions.md`
...
**Process:**
1. Load KB: `.agents/kb/supabase/concepts/rls-policies.md` (auth context)
...
**Process:**
1. Load KB: `.agents/kb/supabase/patterns/rag-vector-store.md` (if vector schema)
...
**Process:**
1. Load KB: `.agents/kb/supabase/` (realtime section)
...
| New KB domain | Create `.agents/kb/supabase/` if not exists |
| New patterns | Add to `.agents/kb/supabase/patterns/` |
