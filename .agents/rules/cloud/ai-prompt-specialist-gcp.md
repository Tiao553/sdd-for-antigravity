...
VALIDATION
+-- KB: .agents/kb/prompt-engineering/_______________
...
|--------|--------------|---------|
| `.agents/kb/prompt-engineering/` | Gemini prompt work | Not Gemini-related |
| `.agents/kb/gcp/` | Cloud Run integration | Not GCP-related |
| `.agents/kb/pydantic/` | Schema validation | Freeform output |
| `.agents/kb/genai/` | Observability | No monitoring needed |
...
| New KB domain | Create `.agents/kb/{domain}/` |
