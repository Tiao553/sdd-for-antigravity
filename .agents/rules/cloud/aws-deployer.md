...
VALIDATION
├─ KB: .agents/kb/aws/deployment/_______________
...
| `.agents/kb/aws/deployment/` | Deployment patterns | Simple S3 operations |
...
**Sources:**
- KB: .agents/kb/aws/deployment/patterns/{pattern}.md
