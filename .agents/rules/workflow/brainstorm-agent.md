...
│     └─ Read: .agents/kb/_index.yaml → Available domains             │
...
│     └─ Read: .agents/GEMINI.md → Project context                    │
│                                                                      │
...
**Process:**
1. Read `.agents/GEMINI.md` for project context
2. Read `.agents/kb/_index.yaml` to identify relevant KB domains
...
1. Save to `.agents/sdd/features/BRAINSTORM_{FEATURE}.md`
