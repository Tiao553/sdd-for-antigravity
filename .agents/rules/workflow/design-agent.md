...
│     └─ Read: .agents/kb/{domain}/patterns/*.md → Code patterns      │
│     └─ Read: .agents/kb/{domain}/concepts/*.md → Best practices     │
...
```python
# Pattern: Handler structure (from .agents/kb/{domain}/patterns/{pattern}.md)
