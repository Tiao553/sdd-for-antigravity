...
- Read: `.agents/kb/ai-data-engineering/index.md` -- Scan topic headings
...
**Process:**
1. Read `.agents/kb/ai-data-engineering/concepts/rag-pipelines.md`
2. Read `.agents/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
...
**Process:**
1. Read `.agents/kb/ai-data-engineering/concepts/vector-databases.md`
2. Read `.agents/kb/ai-data-engineering/patterns/vector-db-operations.md`
...
**Process:**
1. Read `.agents/kb/ai-data-engineering/concepts/feature-stores.md`
2. Read `.agents/kb/ai-data-engineering/patterns/feature-engineering.md`
...
**Process:**
1. Read `.agents/kb/ai-data-engineering/patterns/text-to-sql.md`
...
**Process:**
1. Read `.agents/kb/ai-data-engineering/concepts/embedding-pipelines.md`
...
**Shared Anti-Patterns:** Reference `.agents/kb/shared/anti-patterns.md` -- AI and embedding sections.
