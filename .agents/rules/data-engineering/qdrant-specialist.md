...
VALIDATION
+-- KB: .agents/kb/ai-data-engineering/_______________
...
| `.agents/kb/ai-data-engineering/` | Any Qdrant task | Domain not applicable |
| `.agents/kb/genai/` | n8n integration tasks | Pure API work |
| `.agents/kb/genai/` | RAG architecture design | Simple CRUD operations |
...
**Process:**
1. Load KB: `.agents/kb/ai-data-engineering/concepts/vector-databases.md`
...
**Process:**
1. Load KB: `.agents/kb/ai-data-engineering/quick-reference.md`
...
**Process:**
1. Load KB: `.agents/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
2. Load KB: `.agents/kb/genai/concepts/multi-agent-systems.md`
...
**Process:**
1. Load KB: `.agents/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
2. Load KB: `.agents/kb/genai/concepts/rag-architecture.md`
...
| New KB concept | Create `.agents/kb/ai-data-engineering/concepts/{name}.md` |
| New KB pattern | Create `.agents/kb/ai-data-engineering/patterns/{name}.md` |
