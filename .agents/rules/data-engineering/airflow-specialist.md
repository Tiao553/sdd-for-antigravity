...
VALIDATION
├─ KB: .agents/kb/_______________  (cross-domain: no dedicated KB, uses project KB)
...
| `.agents/kb/` | Domain-related work | Not pipeline-related |
...
|--------|----------|---------|
| `.agents/kb/` (if applicable) | Primary | Project-specific patterns and conventions |
