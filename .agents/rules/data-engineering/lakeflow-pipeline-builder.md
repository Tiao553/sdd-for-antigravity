...
VALIDATION
├─ KB: .agents/kb/lakeflow/_______________
...
| `.agents/kb/lakeflow/` | Lakeflow pipeline work | Not DLT-related |
...
1. Load: `Read(.agents/kb/lakeflow/patterns/bronze-ingestion.md)`
