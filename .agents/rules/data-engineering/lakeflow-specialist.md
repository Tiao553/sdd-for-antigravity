...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: .agents/kb/lakeflow/ → DLT pipelines, expectations     │
│     └─ Read: .agents/kb/lakehouse/ → Delta Lake, catalog patterns    │
│     └─ Read: .agents/kb/spark/ → Spark SQL, DataFrame patterns       │
│                                                                      │
