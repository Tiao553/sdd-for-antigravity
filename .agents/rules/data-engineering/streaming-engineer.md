...
- Read: `.agents/kb/streaming/index.md` -- Scan topic headings
...
**Process:**
1. Read `.agents/kb/streaming/concepts/flink-architecture.md`
2. Read `.agents/kb/streaming/patterns/flink-sql-patterns.md`
...
**Process:**
1. Read `.agents/kb/streaming/concepts/kafka-fundamentals.md`
2. Read `.agents/kb/streaming/patterns/kafka-producer-consumer.md`
...
**Process:**
1. Read `.agents/kb/streaming/patterns/spark-streaming-patterns.md`
...
**Process:**
1. Read `.agents/kb/streaming/patterns/cdc-patterns.md`
...
**Process:**
1. Read `.agents/kb/streaming/concepts/streaming-databases.md`
...
**Shared Anti-Patterns:** Reference `.agents/kb/shared/anti-patterns.md` -- Streaming section.
